...
class Common_Grounds:
    def __init__(self):
        ...
        self.photo = tk.PhotoImage(file=r'/Users/janickolay/Desktop/Spring 2021/INSC 30833/Common Grounds/CG Logo.gif') # specify the path to your file; the r prefix stands for "raw" string
        tk.Label(canvas, image=self.photo, height=50, width=50, anchor='center').grid(row = 0, column = 3)

        titleLabel = tk.Label(canvas, text='CG Coffee Ordering App', bg='#bf8040')
        titleLabel.grid(row=0, column=4)

        descriptionLabel = tk.Label(canvas, text='Please select the type of drink you would like to be described')
    ...
    def yes(self):
        ...
        titleLabel = tk.Label(canvas, text="We reccomend you add some espresso for extra energy.", bg='#bf8040')
        titleLabel.grid(row=0, column=4)

        self.shotCount = tk.StringVar()
        shotCounter = tk.Entry(canvas, text = 'Enter how shots you would like below.', bg='#bf8040', textvariable = self.shotCount)
        shotCounter.grid(row=3, column=4)

        shotLabel = tk.Label(canvas, text="Enter how many shots you would like in the box above.", bg='#bf8040')
    ...
    def summary(self):
        ...
        titleLabel = tk.Label(canvas, text=("""Please find your order below. You would like a %s with %s milk and %s syrup. You also said you wanted %s shot(s) of espresso added. Your order will cost $%.2f""" % (drinkChoice, milkChoice, syrupChoice, espressoShot, drinkCost)), bg='#bf8040')
        titleLabel.grid(row=0, column=4)
